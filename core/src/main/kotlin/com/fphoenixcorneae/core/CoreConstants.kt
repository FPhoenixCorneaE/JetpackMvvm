...
object CoreConstants {
    ...
    object Toolbar {
        ...
        val LEFT_IMAGE_TINT_COLOR = ResourceUtil.getColor(R.color.core_color_title_0x222222)
        const val CENTER_TYPE = CommonTitleBar.TYPE_CENTER_TEXT_VIEW
        val CENTER_TEXT_COLOR = ResourceUtil.getColor(R.color.core_color_title_0x222222)
        ...
        val TITLE_BAR_COLOR = ResourceUtil.getColor(R.color.core_color_toolbar_0xffffff)
        val STATUS_BAR_COLOR = ResourceUtil.getColor(R.color.core_color_statusBar_0xdddddd)
    }
}