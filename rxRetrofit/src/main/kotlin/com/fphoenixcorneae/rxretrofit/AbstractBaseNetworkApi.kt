...
import com.fphoenixcorneae.rxretrofit.factory.CoroutinesCallAdapterFactory
...
abstract class AbstractBaseNetworkApi {
     ...
     */
    open fun OkHttpClient.Builder.setHttpClientBuilder(): OkHttpClient.Builder = apply {
        // 设置缓存配置 缓存最大10M
     ...
     */
    open fun Retrofit.Builder.setRetrofitBuilder(): Retrofit.Builder = apply {
